...
public class Principal {
	...
	public static void main(String[] args) {
		...
		System.out.println("\nAhora vamos a calcular cuant@s " + pueblo + " caben en los diferentes escenarios\n");

		espaciocampnou = campnou / personasporpueblo;
		System.out.printf("En el CampNou caben %.2f %S",espaciocampnou, pueblo);

		espacioestadioolimpico = estadioolimpico / personasporpueblo;
		System.out.printf("\nEn el Estadio Olímpico caben %.2f %S", espacioestadioolimpico, pueblo);

		espacioteatrocolegio = teatrocolegio / personasporpueblo;
		System.out.printf("\nEn el teatro del colegio caben %.2f %S", espacioteatrocolegio, pueblo);
